...
class Bootstrapper(object):
    ...
    def _bootstrap_admin_role(self):
        ...
        # ensure admin does not imply member directly
        #   deployments older than 2023.2 did not have a "manager" role, so
        #   we need to clean up the old admin -> member implied role
